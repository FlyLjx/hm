...
export const updateSettingsSchema = z.object({
  ...
  streamGenerationEnabled: z.boolean().default(false),
  promptModerationEnabled: z.boolean(),
  promptModerationAdultKeywords: z.string().max(10000),
  promptModerationPoliticalKeywords: z.string().max(10000),
  promptModerationRejectMessage: z.string().min(1).max(200),
