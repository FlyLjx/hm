...
import { formatCurrency, formatDate } from '../common/format.js?v=20260713-cache-fix-v1'
import { renderMarkdown } from '../common/markdown.js'
import { pageFromHash } from '../common/navigation.js?v=20260713-cache-fix-v1'
...
const WEB_ASSET_VERSION = '20260713-cache-fix-v1'
