...
export const AccountPoolPage = {
  setup() {
    ...
    return { rows, loading, keyword, statusFilter, typeFilter, fetchedAt, source, settingsLoading, settingsForm, page, pageSize, summary, typeOptions, statusOptions, filteredRows, visibleRows, load, loadSettings, saveSettings, resetFilters, copyValue, statusColor, maskSecret, limitLabel, text, formatDate }
  },
  template: `
    <div class="page-stack">
      ...
      <a-card class="admin-view-card" :bordered="false">
        ...
        <template #extra><a-button type="primary" :loading="settingsLoading" @click="saveSettings">保存配置</a-button></template>
        <div class="form-grid account-pool-config">
          <label class="full">
