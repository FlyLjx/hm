...
import { renderMarkdown } from '../../web/common/markdown.js'
...
export const CrudPage = {
  ...
  setup(props) {
    ...
    const modalWidth = computed(() => dialogFields.value.some((field) => field.preview === 'markdown') ? '1080px' : '860px')
  ...
  template: `
    <div class="crud-page">
      ...
      <a-modal :open="editing !== undefined" :title="(editing ? '编辑' : '新增') + (singular || title)" :width="modalWidth" @cancel="closeForm" @ok="submit">
        <div class="form-grid">
